	...
	<form action="/Sotsuken/divideUpdate" method="post">
		...
		<div class="container-fluid">
			...
			<ul class="nav nav-pills nav-justified botom" id="weekTab">
				<li class="h4 active  bold" id="mon"><input type="hidden" name="mon"><a href="#" draggable="false">月</a></li>
				<li class="h4 bold" id="tue"><input type="hidden"><a href="#" draggable="false">火</a></li>
				<li class="h4 bold" id="wed"><input type="hidden"><a href="#" draggable="false">水</a></li>
				<li class="h4 bold" id="thu"><input type="hidden"><a href="#" draggable="false">木</a></li>
				<li class="h4 bold" id="fri"><input type="hidden"><a href="#" draggable="false">金</a></li>
			</ul>
