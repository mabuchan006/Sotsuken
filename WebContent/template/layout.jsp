...
<body>
	<div class="pure-container" data-effect="pure-effect-scaleRotate">
		...
		<nav class="pure-drawer" data-position="left">
			...
			<ul>
				<li class="select2 moji"><h1 style="padding: 15px 40px; margin: 0;"><a href="/Sotsuken/ManageUpdate?page=teacher_manage">講師管理</a></h1></li>

				<li class="select2 moji"><h1 style="padding: 15px 40px; margin: 0;"><a href="/Sotsuken/ManageUpdate?page=subject_manage">科目管理</a></h1></li>

				<li class="select2 moji"><h1 style="padding: 15px 40px; margin: 0;"><a href="/Sotsuken/ManageUpdate?page=class_manage">クラス管理</a></h1></li>
